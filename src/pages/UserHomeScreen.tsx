...
const UserHomeScreen: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4 pt-16 sm:pt-20">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <div className="mx-auto mb-4 h-28 w-28 rounded-full bg-gray-200 flex items-center justify-center text-gray-400">
